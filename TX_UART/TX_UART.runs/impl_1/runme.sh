...
HD_PWD='D:/Vivado/TTCS2/TX_UART/TX_UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TX_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TX_design_wrapper.tcl -notrace
