...
HD_PWD='D:/Vivado/TTCS2/TX_UART/TX_UART.runs/TX_design_TX_UART_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TX_design_TX_UART_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TX_design_TX_UART_0_0.tcl
