...
HD_PWD='D:/Vivado/TTCS2/TX_UART/TX_UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TX_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TX_design_wrapper.tcl
