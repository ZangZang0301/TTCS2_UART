...
HD_PWD='D:/Vivado/TTCS2/RX_UART/RX_UART.runs/UART_RX_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_RX_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_RX_ila_0_0.tcl
