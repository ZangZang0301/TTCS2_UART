...
HD_PWD='D:/Vivado/TTCS2/RX_UART/RX_UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_RX_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UART_RX_wrapper.tcl -notrace
