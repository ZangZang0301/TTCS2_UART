...
HD_PWD='D:/Vivado/TTCS2/RX_UART/RX_UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_RX_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_RX_wrapper.tcl
