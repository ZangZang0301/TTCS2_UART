...
HD_PWD='D:/Vivado/TTCS2/TTCS2_1/TTCS2_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TTCS_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TTCS_1_wrapper.tcl -notrace
