...
HD_PWD='D:/Vivado/TTCS2/TTCS2_1/TTCS2_1.runs/TTCS_1_freq_divider_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TTCS_1_freq_divider_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TTCS_1_freq_divider_0_0.tcl
